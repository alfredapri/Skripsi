...
\begin{longtable}{|p{3cm} | c p{10cm}|}
	...
	\hline \multicolumn{3}{|r|}{{Lanjut di halaman selanjutnya...}} \\ \hline
	\endfoot
	
	\hline
	\endlastfoot

        Nama & \multicolumn{2}{p{10.5cm} |}{Mencari lokasi menggunakan kata kunci pencarian} \\
    \hline \addlinespace[0.1cm]
    \hline
        Deskripsi & \multicolumn{2}{p{10.5cm} |}{Fitur untuk mencari lokasi di area tertentu berdasarkan kata kunci pencarian.} \\
    \hline
		Aktor & \multicolumn{2}{p{10.5cm} |}{Pengguna aplikasi} \\
	\hline
		Pre-kondisi & \multicolumn{2}{p{10.5cm} |}{-} \\
    \hline
		Pos-kondisi & \multicolumn{2}{p{10.5cm} |}{Nama dari lokasi serta koordinat \textit{latitude} dan \textit{longitude}-nya ditampilkan kepada pengguna.} \\
    \hline
...
\begin{longtable}{|p{3cm} | c p{10cm}|}
	...
	\endlastfoot
        ...
        Nama & \multicolumn{2}{p{10.5cm} |}{Mencari rute dengan angkot menggunakan \latlon lokasi} \\
    \hline \addlinespace[0.1cm]
    \hline
        Deskripsi & \multicolumn{2}{p{10.5cm} |}{Fitur untuk mencari cara pergi ke satu lokasi ke lokasi lainnya dengan menggunakan angkot dengan nilai \latlon lokasi sebagai masukan.} \\
    \hline
		Aktor & \multicolumn{2}{p{10.5cm} |}{Pengguna aplikasi} \\
	\hline
		Pre-kondisi & \multicolumn{2}{p{10.5cm} |}{-} \\
    \hline
		Pos-kondisi & \multicolumn{2}{p{10.5cm} |}{Langkah-langkah yang harus ditempuh untuk perjalanan tersebut akan ditampilkan kepada pengguna.} \\
    \hline
...
\begin{longtable}{|p{3cm} | c p{10cm}|}
	...
	\endlastfoot
        ...
        Nama & \multicolumn{2}{p{10.5cm} |}{Mencari rute dengan angkot menggunakan kata kunci pencarian lokasi} \\
    \hline \addlinespace[0.1cm]
    \hline
        Deskripsi & \multicolumn{2}{p{10.5cm} |}{Fitur untuk mencari cara pergi ke satu lokasi ke lokasi lainnya dengan menggunakan angkot dengan dengan kata kunci pencarian kedua lokasi sebagai masukan.} \\
    \hline
		Aktor & \multicolumn{2}{p{10.5cm} |}{Pengguna aplikasi} \\
	\hline
		Pre-kondisi & \multicolumn{2}{p{10.5cm} |}{-} \\
