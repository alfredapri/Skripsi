...
\begin{figure}[t]
    ...
    \caption[Halaman web \textit{API Keys} KIRI.]{Halaman web \textit{API Keys} KIRI\footnotemark.}
    \label{fig:kiri-apikeypage}
\end{figure}
\footnotetext{Bagian tengah kunci API ditutup untuk alasan keamanan. Kunci-kunci API yang tidak berhubungan dengan perkakas di skripsi ini ditutup total.}
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item \textit{Array} \latlon\xspace lokasi\\
			\textit{Array} nilai-nilai desimal \latlon\xspace dari berbagai titik lokasi yang terdapat dalam rute.
			\newpage % prevent widow
...
\begin{figure}[h]
    \centering
    \includegraphics[height=5.5cm]{cli-windows-powershell}
...
\begin{figure}[ht]
    \begin{subfigure}[b]{0.475\linewidth}
		\centering
		\includegraphics[height=5.5cm]{cli-cliexample}
    ...
    \begin{subfigure}[b]{0.475\linewidth}
		\centering
		\includegraphics[height=5.5cm]{cli-guiexample}
...
Selain dari tampilannya sendiri, ada beberapa perbedaan lain antara antarmuka CLI dengan antarmuka berbasis \gui. Adapun perbedaan-perbedaan utama dari kedua jenis antarmuka ini adalah sebagai berikut \cite{mueller:2007:windowscommandline}.
\begin{itemize}
...
\newpage\vspace*{-3em}  % prevent awkward chapter positioning
\begin{figure}[ht]
    \centering
...
%\vspace{-0.1em} % prevent awkward chapter positioning
\begin{verbatim}
                                 whatis ls
\end{verbatim}
%\vspace{-0.1em}
...
\begin{figure}[ht]
    \begin{subfigure}[b]{0.495\linewidth}
		\centering
		\includegraphics[width=\linewidth]{cli-windows-cmd}
    ...
    \begin{subfigure}[b]{0.495\linewidth}
		\centering
		\includegraphics[width=\linewidth]{cli-windows-powershell}
...
\verb|getopt| merupakan sebuah fungsi yang dapat mengautomasikan pekerjaan-pekerjaan yang berhubungan dengan penerimaan opsi-opsi untuk \cl\xspace berbasis UNIX.
\newline\newline\noindent
...
\newline\newline % fix awkward section formatting
...
\begin{lstlisting}[language=C, caption=Contoh sederhana penggunaan getopt\textunderscore long, label=code:getopt-usage-long]
#include <stdio.h>
#include <stdlib.h>
#include <getopt.h>
...
\vspace{-0.2em} % fix awkward spacing
...
\begin{itemize}[listparindent=\parindent]
	...
	\newpage % prevent widow
	\vspace*{-1.25em} % prevent widow on next page
	...
	\vspace{-0.1em} % prevent widow on next page
	\begin{verbatim}
                            cJSON_Parse(<JSON>)
	\end{verbatim}
	\vspace{-0.1em} % prevent widow on next page
...
add_executable(Hello Hello.c)
	...
	\begin{itemize}
		...
		\begin{figure}[ht]
		    \centering
		    \includegraphics[width=0.9\linewidth]{cmake-gui}
		...
		\begin{figure}[ht]
		    \centering
		    \includegraphics[width=0.75\linewidth]{cmake-ccmake}
